...
try {
    Write-Host 'Step 2: Migrating data...' -ForegroundColor Yellow
    Get-Content step2-migrate-data.sql | npx prisma db execute --stdin
    Write-Host 'SUCCESS! All data migrated!' -ForegroundColor Green
} finally {
